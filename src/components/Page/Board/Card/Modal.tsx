                    ...
                    <main className="w-full flex flex-row items-center justify-center p-4 gap-x-6">
                        <div className="h-full py-8">
                            <header className="w-full items-start">
                                ...
                                <h1 className="text-title-about text-gray-120 text-xl">Modal Title</h1>
                            </header>
                            ...
                            <section className="w-full items-start flex flex-col gap-y-5 ">
                                ...
                                <fieldset className="mb-[15px] flex items-center gap-5">
                                    <textarea name="" id="" cols={50} rows={5} placeholder="Write Here!"
                            ...
                            <div className="mt-[25px] flex flex-col justify-end">
                                <div>
                                    <input type="text" className="bg-gray-20 w-full  h-9 rounded-md p-4" placeholder="New comment or activity" />
                                </div>
                            </div>
                        </div>
                        <div>
