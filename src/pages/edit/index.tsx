...
export default function EditAcount() {
    return (
        <main className="w-full h-full flex flex-row items-center justify-center bg-slate-300 gap-x-14 pt-11 pb-56">
            <section className="w-[266px] h-[calc(100vh-7rem-4rem-42px-60px)] flex flex-col items-center justify-center pb-16">
                <Aside />
            </section>
            <section className='h-[calc(100vh-7rem-4rem-42px-60px)] flex flex-col items-start justify-start gap-y-3'>
                <header>
                    <h1 className="text-title">Your account</h1>
                </header>
                <main className='bg-white w-[668px] h-max flex flex-col items-start justify-start rounded-[10px] gap-y-9'>
